...
parser.add_argument("--local", action="store_true", default=False) # launches local circuit experiments
parser.add_argument("--glob", action="store_true", default=False) # launches global circuit experiments
parser.add_argument("--task_ablation", action="store_true", default=False) # launches task ablation experiments : partition nodes, label these partitions per task
...
if __name__ == "__main__":
    ...
    if args.task_ablation:
        raise NotImplementedError("Task ablation experiments are not implemented yet.")